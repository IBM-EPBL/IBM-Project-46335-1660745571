...
#conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=98538591-7217-4024-b027-8baa776ffad1.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=30875;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=wzl67403;PWD=GhnSbpHNQ0cNxoMe;,", '', '')
...
def updatecomplaint():
    if request.method == 'POST':
        ...
        try:
            sql = "update complaints set solution =? where c_id = ? and assigned_agent=?"
            stmt = ibm_db.prepare(conn, sql)
